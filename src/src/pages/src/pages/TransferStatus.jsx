    ...
    <div className="max-w-md mx-auto p-4 min-h-screen flex items-center justify-center">
      <div className="w-full">
        <div className={`${statusDisplay.bgColor} border ${statusDisplay.borderColor} rounded-xl p-8 text-center`}>
          ...
          {loading && (
            <p className="text-gray-400 text-sm">Please wait while we process your transfer...</p>
          )}
          ...
          <button
            onClick={() => navigate('/')}
            className="mt-6 w-full py-3 bg-blue-600 hover:bg-blue-700 rounded-lg font-medium transition"
          >
            New Transfer
          </button>
        </div>
